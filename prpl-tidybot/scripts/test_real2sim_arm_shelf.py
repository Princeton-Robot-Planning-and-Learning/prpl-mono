...
from prpl_tidybot.perceivers.prbench_shelf_perceiver import PRBenchShelfPerceiver
...
def real2sim() -> None:
    """Test move-base-arm in ground environment with 1 cube and a shelf."""
    ...
    try:
        ...
        perceiver = PRBenchShelfPerceiver(interface)
