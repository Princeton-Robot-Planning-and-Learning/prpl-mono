...
# Controllers.
class GroundPickBlockNotOnShelfController(Kinematic2dRobotController):
...
class GroundPlaceBlockOnShelfController(Kinematic2dRobotController):
...
class GroundPlaceBlockNotOnShelfController(Kinematic2dRobotController):
