...
from kinder.envs.geom3d.motion3d import ObjectCentricMotion3DEnv
...
def collect_data(
    ...
    if "Shelf3D" in env_name:
        ...
        from kinder_models.geom3d.shelf3d.parameterized_skills import (  # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    elif "Ground3D" in env_name:
        sim = ObjectCentricGround3DEnv(num_cubes=num_cubes)  # type: ignore
        from kinder_models.geom3d.ground3d.parameterized_skills import (  # type: ignore # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    elif "Transport3D" in env_name:
        sim = ObjectCentricTransport3DEnv(num_cubes=num_cubes)  # type: ignore
        from kinder_models.geom3d.transport3d.parameterized_skills import (  # type: ignore # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    elif "BaseMotion3D" in env_name:
        sim = ObjectCentricBaseMotion3DEnv()  # type: ignore
        from kinder_models.geom3d.base_motion3d.parameterized_skills import (  # type: ignore # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    elif "Motion3D" in env_name:
        sim = ObjectCentricMotion3DEnv()  # type: ignore
        from kinder_models.geom3d.motion3d.parameterized_skills import (  # type: ignore # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    elif "Obstruction3D" in env_name:
        sim = ObjectCentricObstruction3DEnv(num_obstructions=num_cubes)  # type: ignore
        from kinder_models.geom3d.obstruction3d.parameterized_skills import (  # type: ignore # pylint: disable=import-outside-toplevel
            create_lifted_controllers,
        )
    else:
