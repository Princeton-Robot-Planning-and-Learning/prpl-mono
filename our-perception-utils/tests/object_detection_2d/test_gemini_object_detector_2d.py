...
import pytest
from our_llm_utils.cache import SQLite3PretrainedLargeModelCache

from our_perception_utils.object_detection_2d.gemini_object_detector_2d import (
    GeminiObjectDetector2D,
)
from our_perception_utils.object_detection_2d.render_wrapper import (
