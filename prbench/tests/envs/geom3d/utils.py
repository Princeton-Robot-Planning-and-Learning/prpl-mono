...
# Default demos directory: prbench/demos relative to this file
# Utils file: prpl-mono/prbench/tests/envs/geom3d/utils.py
# Demos:      prpl-mono/prbench/demos
_UTILS_DIR = Path(__file__).resolve().parent
DEFAULT_DEMOS_DIR = _UTILS_DIR.parent.parent.parent / "demos"
