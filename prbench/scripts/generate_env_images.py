...
# Row height: 200 pixels, varying column widths for balanced appearance
ENV_CONFIGS = [
    # Row 1: 7 environments (y=0, 171px width each)
    EnvImageConfig(
    ...
    EnvImageConfig(
        env_id="prbench/TidyBot3D-sort-lab2-o20-SortClutteredBlocks-v0",
        seed=42,
        crop=None,
        position=(600, 400),
        scale=0.2,
    ...
    # Row 4: 6 environments (y=600, 200px width each)
    # TODO: prbench/tidybot-namo-o1-v0 does not exist yet - using placeholder
    EnvImageConfig(
        env_id="prbench/TidyBot3D-balance-o4-v0",
        seed=42,
        crop=None,
        position=(0, 600),
        scale=0.2,
    ...
    # TODO: Add 4 more environments for row 4
    # Positions: (400, 600), (600, 600), (800, 600), (1000, 600)
]
