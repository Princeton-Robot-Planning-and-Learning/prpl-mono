"""This module defines the TidyBotRobotEnvMJX class, which uses MJX for GPU-accelerated
simulation of the TidyBot robot."""
...
from prbench.envs.dynamic3d.mjx.mjx_utils import MjObs, MujocoEnv
