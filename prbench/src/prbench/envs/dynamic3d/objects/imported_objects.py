...
from prbench.envs.dynamic3d.objects.base import REGISTERED_OBJECTS, register_object
from prbench.envs.dynamic3d.objects.robocasa_objects import (
    REPLICA_OBJECTS_DIR,
    RoboCasaObject,
)
...
def _create_replica_object_classes() -> None:
    ...
    for object_dir in sorted(REPLICA_OBJECTS_DIR.iterdir()):
        ...
        # e.g., "frl_apartment_chair_01" -> "ReplicaFrlApartmentChair01"
        class_name_parts = ["Replica"] + [
