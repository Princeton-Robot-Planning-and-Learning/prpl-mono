# TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_on_the_left_side_of_the_bowl

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_on_the_left_side_of_the_bowl-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_on_the_left_side_of_the_bowl.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_on_the_left_side_of_the_bowl.gif)
