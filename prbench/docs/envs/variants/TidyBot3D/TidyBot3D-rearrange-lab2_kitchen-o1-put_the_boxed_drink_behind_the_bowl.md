# TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_behind_the_bowl

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-rearrange-lab2_kitchen-o1-put_the_boxed_drink_behind_the_bowl-v0")
```
