...
```python
import prbench
env = prbench.make("prbench/TidyBot3D-table-o5-v0")
```

## Description
This variant uses the 'table' scene type with 5 objects.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-table-o5.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-table-o5.gif)
