# TidyBot3D-base_motion-o1

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-base_motion-o1-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-base_motion-o1.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-base_motion-o1.gif)
