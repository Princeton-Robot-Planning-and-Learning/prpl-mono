# TidyBot3D-cupboard-o8

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-cupboard-o8-v0")
```

## Description
This variant uses the 'cupboard' scene type with 8 objects.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-cupboard-o8.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-cupboard-o8.gif)
