...
## Description
This variant uses the 'ground' scene type with 1 object.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-ground-o1.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-ground-o1.gif)
