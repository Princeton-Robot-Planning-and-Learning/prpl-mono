# TidyBot3D-SweepSimple3D-lab2_kitchen-o1-sweep_the_blocks_to_the_left_side_of_the_kitchen_island

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-SweepSimple3D-lab2_kitchen-o1-sweep_the_blocks_to_the_left_side_of_the_kitchen_island-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-SweepSimple3D-lab2_kitchen-o1-sweep_the_blocks_to_the_left_side_of_the_kitchen_island.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-SweepSimple3D-lab2_kitchen-o1-sweep_the_blocks_to_the_left_side_of_the_kitchen_island.gif)
