# TidyBot3D-BalanceBeam3D-lab2-o3-balance_beam

## Usage
```python
import prbench
env = prbench.make("prbench/TidyBot3D-BalanceBeam3D-lab2-o3-balance_beam-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-BalanceBeam3D-lab2-o3-balance_beam.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-BalanceBeam3D-lab2-o3-balance_beam.gif)
