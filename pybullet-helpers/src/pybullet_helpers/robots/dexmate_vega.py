...
# Link pairs to check for self-collision on the bimanual robot: the two arms can
# cross in front of the torso and reach the head. Discovered by sampling random
# whole-body configurations (see scripts/discover_dexmate_vega_self_collision_pairs.py)
# and frozen here; each arm view checks the subset of pairs involving its own links.
_SELF_COLLISION_LINK_PAIRS: list[tuple[str, str]] = [
    ("L_arm_l1", "R_arm_l5"),
    ("L_arm_l1", "R_arm_l6"),
    ("L_arm_l1", "R_arm_l7"),
    ("L_arm_l1", "R_arm_l8"),
    ("L_arm_l1", "R_gripper_base"),
    ("L_arm_l1", "R_gripper_l1"),
    ("L_arm_l1", "R_gripper_l2"),
    ("L_arm_l2", "R_arm_l5"),
    ("L_arm_l2", "R_arm_l6"),
    ("L_arm_l2", "R_arm_l7"),
    ("L_arm_l2", "R_arm_l8"),
    ("L_arm_l2", "R_gripper_base"),
    ("L_arm_l2", "R_gripper_l1"),
    ("L_arm_l2", "R_gripper_l2"),
    ("L_arm_l3", "R_arm_l5"),
    ("L_arm_l3", "R_arm_l6"),
    ("L_arm_l3", "R_arm_l7"),
    ("L_arm_l3", "R_arm_l8"),
    ("L_arm_l3", "R_gripper_base"),
    ("L_arm_l3", "R_gripper_l1"),
    ("L_arm_l3", "R_gripper_l2"),
    ("L_arm_l4", "R_arm_l4"),
    ("L_arm_l4", "R_arm_l5"),
    ("L_arm_l4", "R_arm_l6"),
    ("L_arm_l4", "R_arm_l7"),
    ("L_arm_l4", "R_arm_l8"),
    ("L_arm_l4", "R_gripper_base"),
    ("L_arm_l4", "R_gripper_l1"),
    ("L_arm_l4", "R_gripper_l2"),
    ("L_arm_l5", "R_arm_l2"),
    ("L_arm_l5", "R_arm_l3"),
    ("L_arm_l5", "R_arm_l4"),
    ("L_arm_l5", "R_arm_l5"),
    ...
    ("L_arm_l5", "R_arm_l7"),
    ("L_arm_l5", "R_arm_l8"),
    ("L_arm_l5", "R_gripper_base"),
    ("L_arm_l5", "R_gripper_l1"),
    ("L_arm_l5", "R_gripper_l2"),
    ("L_arm_l6", "R_arm_l1"),
    ("L_arm_l6", "R_arm_l2"),
    ("L_arm_l6", "R_arm_l3"),
    ("L_arm_l6", "R_arm_l4"),
    ...
    ("L_arm_l6", "R_arm_l7"),
    ("L_arm_l6", "R_arm_l8"),
    ("L_arm_l6", "R_gripper_base"),
    ("L_arm_l6", "R_gripper_l1"),
    ("L_arm_l6", "R_gripper_l2"),
    ("L_arm_l7", "R_arm_l1"),
    ("L_arm_l7", "R_arm_l2"),
    ("L_arm_l7", "R_arm_l3"),
    ("L_arm_l7", "R_arm_l4"),
    ...
    ("L_arm_l7", "R_arm_l7"),
    ("L_arm_l7", "R_arm_l8"),
    ("L_arm_l7", "R_gripper_base"),
    ("L_arm_l7", "R_gripper_l1"),
    ("L_arm_l7", "R_gripper_l2"),
    ("L_arm_l8", "R_arm_l1"),
    ("L_arm_l8", "R_arm_l2"),
    ("L_arm_l8", "R_arm_l3"),
    ("L_arm_l8", "R_arm_l4"),
    ...
    ("L_arm_l8", "R_arm_l7"),
    ("L_arm_l8", "R_arm_l8"),
    ("L_arm_l8", "R_gripper_base"),
    ("L_arm_l8", "R_gripper_l1"),
    ("L_arm_l8", "R_gripper_l2"),
    ("L_gripper_base", "R_arm_l1"),
    ("L_gripper_base", "R_arm_l2"),
    ("L_gripper_base", "R_arm_l3"),
    ("L_gripper_base", "R_arm_l4"),
    ("L_gripper_base", "R_arm_l5"),
    ("L_gripper_base", "R_arm_l6"),
    ("L_gripper_base", "R_arm_l7"),
    ("L_gripper_base", "R_arm_l8"),
    ("L_gripper_base", "R_gripper_base"),
    ("L_gripper_base", "R_gripper_l1"),
    ("L_gripper_base", "R_gripper_l2"),
    ("L_gripper_l1", "R_arm_l1"),
    ("L_gripper_l1", "R_arm_l2"),
    ("L_gripper_l1", "R_arm_l3"),
    ("L_gripper_l1", "R_arm_l4"),
    ("L_gripper_l1", "R_arm_l5"),
    ("L_gripper_l1", "R_arm_l6"),
    ("L_gripper_l1", "R_arm_l7"),
    ("L_gripper_l1", "R_arm_l8"),
    ("L_gripper_l1", "R_gripper_base"),
    ("L_gripper_l1", "R_gripper_l1"),
    ("L_gripper_l1", "R_gripper_l2"),
    ("L_gripper_l2", "R_arm_l1"),
    ("L_gripper_l2", "R_arm_l2"),
    ("L_gripper_l2", "R_arm_l3"),
    ("L_gripper_l2", "R_arm_l4"),
    ("L_gripper_l2", "R_arm_l5"),
    ("L_gripper_l2", "R_arm_l6"),
    ("L_gripper_l2", "R_arm_l7"),
    ("L_gripper_l2", "R_arm_l8"),
    ("L_gripper_l2", "R_gripper_base"),
    ("L_gripper_l2", "R_gripper_l1"),
    ("L_gripper_l2", "R_gripper_l2"),
    ("head_l1", "L_arm_l4"),
    ("head_l1", "L_arm_l5"),
    ("head_l1", "L_arm_l6"),
    ("head_l1", "L_arm_l7"),
    ("head_l1", "L_arm_l8"),
    ("head_l1", "L_gripper_base"),
    ("head_l1", "L_gripper_l1"),
    ("head_l1", "L_gripper_l2"),
    ("head_l1", "R_arm_l4"),
    ("head_l1", "R_arm_l5"),
    ("head_l1", "R_arm_l6"),
    ("head_l1", "R_arm_l7"),
    ("head_l1", "R_arm_l8"),
    ("head_l1", "R_gripper_base"),
    ("head_l1", "R_gripper_l1"),
    ("head_l1", "R_gripper_l2"),
    ("head_l2", "L_arm_l4"),
    ("head_l2", "L_arm_l5"),
    ("head_l2", "L_arm_l6"),
    ("head_l2", "L_arm_l7"),
    ("head_l2", "L_arm_l8"),
    ("head_l2", "L_gripper_base"),
    ("head_l2", "L_gripper_l1"),
    ("head_l2", "L_gripper_l2"),
    ("head_l2", "R_arm_l4"),
    ("head_l2", "R_arm_l5"),
    ("head_l2", "R_arm_l6"),
    ("head_l2", "R_arm_l7"),
    ("head_l2", "R_arm_l8"),
    ("head_l2", "R_gripper_base"),
    ("head_l2", "R_gripper_l1"),
    ("head_l2", "R_gripper_l2"),
    ("head_l3", "L_arm_l4"),
    ("head_l3", "L_arm_l5"),
    ("head_l3", "L_arm_l6"),
    ("head_l3", "L_arm_l7"),
    ("head_l3", "L_arm_l8"),
    ("head_l3", "L_gripper_base"),
    ("head_l3", "L_gripper_l1"),
    ("head_l3", "L_gripper_l2"),
    ("head_l3", "R_arm_l4"),
    ("head_l3", "R_arm_l5"),
    ("head_l3", "R_arm_l6"),
    ("head_l3", "R_arm_l7"),
    ("head_l3", "R_arm_l8"),
    ("head_l3", "R_gripper_base"),
    ("head_l3", "R_gripper_l1"),
    ("head_l3", "R_gripper_l2"),
]
...
class _DexmateVegaArm(FingeredSingleArmPyBulletRobot[float]):
    ...
    def self_collision_link_names(self) -> list[tuple[str, str]]:
        # The subset of the bimanual self-collision pairs that involve this arm's links
        # (against the other arm and the head). These resolve even when the arm is used
        # standalone, since the gripper URDF contains both arms and the head.
        prefix = f"{self._side}_"
        return [
            pair
            for pair in _SELF_COLLISION_LINK_PAIRS
