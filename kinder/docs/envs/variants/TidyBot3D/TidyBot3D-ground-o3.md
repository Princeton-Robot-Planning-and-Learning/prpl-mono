...
```python
import kinder
env = kinder.make("kinder/TidyBot3D-ground-o3-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-ground-o3.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-ground-o3.gif)
