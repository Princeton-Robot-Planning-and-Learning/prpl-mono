...
from kinder_rl.random_agent import RandomAgent


def test_random_agent_with_kinder_environment():
    """Test RandomAgent with continuous action space from KinDER environment."""
...
def test_random_agent_seeded_reproducibility_with_kinder():
    """Test seeded reproducibility with KinDER environment actions."""
    kinder.register_all_environments()
    env = kinder.make("kinder/StickButton2D-b5-v0")
