...
class BasePlaceController(
    ...
    def get_arm_motion_plan(self, real: bool = False) -> None:
        ...
        try:
            if real:
                collision_ids = {self._sim.table_id}  # type: ignore # pylint: disable=protected-access
    ...
    def get_retract_motion_plan(self) -> None:
        self._sim.set_state(self._current_state)
