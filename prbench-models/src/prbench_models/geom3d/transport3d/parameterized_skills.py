...
class GroundPickController(
    ...
    def get_arm_motion_plan(self) -> None:
        self._sim.set_state(self._current_state)
    ...
    def get_retract_motion_plan(self, real: bool = False) -> None:
        ...
        if real:
            joint_plan = run_motion_planning(  # type: ignore
                ...
                collision_bodies={self._sim.table_id},  # type: ignore # pylint: disable=protected-access
                seed=0,  # for determinism
...
class GroundPlaceController(BasePlaceController):
    ...
    def get_base_motion_plan(self, real: bool = False) -> None:
        self._sim.set_state(self._current_state)
