            ...
            if args.language:
                if len(reader.target_object_key) > 0:
                    ...
                    if args.navigation_only:
                        ...
                        episode_group.create_dataset('language', data=f"Pick the {target_object_key} and place it on the shelf.")
                else:
                    episode_group.create_dataset('language', data="Pick the target object and place it on the shelf.")
            if args.predicate:
