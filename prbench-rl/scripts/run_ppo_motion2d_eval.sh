...
for seed in "${SEEDS[@]}"; do
    ...
    python experiments/run_experiment.py \
        ...
        seed=${seed} \
        agent.exp_name="ppo_m2d_0_passage_seed_${seed}_eval" \
        eval_episodes=50 \
        load_agent_path="runs/ppo_m2d_0_passage_seed_${seed}/final_ckpt.pt"
...
for seed in "${SEEDS[@]}"; do
    ...
    python experiments/run_experiment.py \
        ...
        eval_episodes=50 \
        load_agent_path="runs/ppo_m2d_2_passage_seed_${seed}/final_ckpt.pt"
